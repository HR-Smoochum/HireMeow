...
router.put('/seekers', controller.updateJobApplied);
router.put('/seekers', controller.updateJobInterested);
router.put('/employers', controller.updateEmployerInterested);
